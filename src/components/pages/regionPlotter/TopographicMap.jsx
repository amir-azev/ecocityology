...
function TopographicMap({
  ...
  const handleGenerateRegionMap = async () => {
    ...
    const { matrix, width, height } = buildRegionElevationMatrix(
      tilesData,
      minTileX,
      minTileY,
      maxTileX,
    ...
    setRegionElevationMatrix(matrix);
  ...
  // -------------------------------------------
  function buildRegionElevationMatrix(
    tilesData,
    minTileX,
    minTileY,
    maxTileX,
        ...
        <div className="pt-4 text-gray-800">
          ...
          <p>
            ...
            {(() => {
              ...
              const centerElevation = regionElevationMatrix[centerIdx];
